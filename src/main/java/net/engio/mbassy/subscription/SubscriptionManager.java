        ...
        try {
            ...
            if (subscriptionsByListener == null) {
                ...
                if (messageHandlers.length == 1){
                    Class[] messageClasses = messageHandlers[0].getHandledMessages();
                    if (messageClasses.length ==1 && messageClasses[0] == Event.class) {
                        Class eventClass = (Class) listener.getClass().getField("eventClass").get(listener);
                        messageClasses[0] = eventClass;
                    }
                }
